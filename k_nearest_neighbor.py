...
def distance_apart(query_instance, training_set, cluster_size):
...
if __name__ == "__main__":
	query, training, cluster_size = (7, 6), [(7, 7, 'bad'), (7, 4, 'bad'), (3, 4, 'good'), (1, 4, 'good')], 3 
	print(distance_apart(query, training, cluster_size ))